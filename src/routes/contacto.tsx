      ...
      <section className="bg-light py-24">
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
              {submitted ? (
                <div className="border border-[#14141420] p-12 text-center">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full border border-[#14141420] bg-transparent p-4 text-[#141414] focus:border-[#141414] focus:outline-none transition-colors"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full border border-[#14141420] bg-transparent p-4 text-[#141414] focus:border-[#141414] focus:outline-none transition-colors resize-none"
                  ...
                  <button
                    ...
                    className="w-full bg-[#141414] text-[#ffffff] py-4 font-semibold uppercase tracking-wide hover:bg-[#2a2a2a] transition-colors disabled:opacity-50"
                  >
              ...
              <div className="pt-8 border-t border-[#14141420]">
                ...
                <div className="flex gap-4">
                  <a
                    ...
                    className="w-12 h-12 border border-[#14141430] flex items-center justify-center text-[#141414] hover:bg-[#141414] hover:text-[#ffffff] transition-all"
                  >
